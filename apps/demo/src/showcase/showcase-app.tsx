...
const COMPONENTS: ComponentMeta[] = [
  ...
  },
  {
    ...
    title: "Modal",
    description:
      "An opinionated modal with sticky header, scrollable body, and sticky footer built on Dialog.",
    demo: ModalDemo,
  },
  {
    name: "alert-dialog",
  ...
  },
  {
    ...
    title: "Stepper",
    description:
      "A horizontal multi-step progress indicator with completed, current, and pending states.",
    demo: StepperDemo,
  },
  {
...
const CATEGORIES: SidebarCategory[] = [
  ...
  },
  {
    label: "Overlay",
    items: COMPONENTS.filter((c) =>
      ["dropdown-menu", "modal", "popover", "sheet", "tooltip"].includes(
        c.name
      )
    ).sort((a, b) => a.title.localeCompare(b.title)),
  },
  {
    label: "Navigation",
    items: COMPONENTS.filter((c) =>
      ["accordion", "breadcrumb", "collapsible", "command", "pagination", "scroll-area", "separator", "stepper", "tabs"].includes(c.name)
    ).sort((a, b) => a.title.localeCompare(b.title)),
  },
  {
    label: "Toggle",
  ...
  },
  {
    label: "Utilities",
    items: COMPONENTS.filter((c) =>
      ["pattern-background"].includes(c.name)
    ).sort((a, b) => a.title.localeCompare(b.title)),
  },
];
