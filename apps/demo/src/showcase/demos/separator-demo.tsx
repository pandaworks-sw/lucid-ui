...
<div className="flex h-5 items-center space-x-4">
  ...
  <span>Item B</span>
      ...
      >
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Track and manage employee performance reviews.</p>
          </div>
          <Separator />
          <div>
            <h3 className="text-lg font-medium">Recruitment</h3>
            <p className="text-sm text-muted-foreground">Streamline your hiring pipeline.</p>
          </div>
        </div>
      </DemoSection>
      ...
      <DemoSection title="Separator with Surrounding Content">
        <div className="space-y-4">
          <p className="text-sm">
            Separators visually divide content into clear groups. Use horizontal separators between stacked sections and
