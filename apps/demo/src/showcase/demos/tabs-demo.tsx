      ...
      <DemoSection title="Vertical Orientation">
        <Tabs defaultValue="general" orientation="vertical" className="w-full max-w-md">
          ...
          <TabsContent value="security">
            <div className="rounded-lg border p-4">
              <p className="text-sm text-muted-foreground">Security and access control settings.</p>
            </div>
          </TabsContent>
      ...
      <DemoSection title="Vertical Line Variant">
        <Tabs defaultValue="overview" orientation="vertical" className="w-full max-w-md">
          ...
          <TabsContent value="overview">
            <div className="rounded-lg border p-4">
              <p className="text-sm text-muted-foreground">A high-level summary of your data.</p>
            </div>
          </TabsContent>
      ...
      <DemoSection title="Disabled Tab">
        <Tabs defaultValue="active" className="w-full max-w-md">
          ...
          <TabsContent value="active">
            <div className="rounded-lg border p-4">
              <p className="text-sm text-muted-foreground">This tab is active. The middle tab is disabled.</p>
            </div>
          </TabsContent>
