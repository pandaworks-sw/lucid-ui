...
export default function AttachmentInputDemo() {
  ...
  const [compactSingle, setCompactSingle] = useState<AttachmentFile | null>(null);
...
/>`}
      ...
      <DemoSection title="Multiple Files (Dropzone)">
        <div className="grid w-full max-w-md gap-1.5">
          <p className="text-sm text-muted-foreground">Select multiple files. Duplicates are automatically skipped.</p>
          <AttachmentInput
            mode="multiple"
            value={multipleFiles}
      ...
      <DemoSection title="Single File (Compact)">
        <div className="grid w-full max-w-sm gap-1.5">
          <p className="text-sm text-muted-foreground">A compact attachment input that looks like a form field.</p>
          <AttachmentInput
            mode="single"
            variant="compact"
            value={compactSingle}
      ...
      <DemoSection title="Multiple Files (Compact)">
        <div className="grid w-full max-w-sm gap-1.5">
          ...
          <AttachmentInput mode="multiple" variant="compact" value={compactMultiple} onChange={setCompactMultiple} />
        </div>
      </DemoSection>
      ...
      <DemoSection title="Pre-populated (Edit Form)">
        <div className="grid w-full max-w-md gap-1.5">
          <p className="text-sm text-muted-foreground">
            Existing attachments from a saved record. New files can be added alongside them.
          </p>
          <AttachmentInput
            mode="multiple"
            value={existingFiles}
      ...
      <DemoSection title="Disabled">
        <div className="grid w-full max-w-md gap-1.5">
          <p className="text-sm text-muted-foreground">A disabled attachment input that cannot be interacted with.</p>
          <AttachmentInput
            mode="single"
            value={{
