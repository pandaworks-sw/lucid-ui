...
const listRowVariants = cva('flex w-full items-center gap-3 text-left transition-colors', {
  variants: {
    density: {
      sm: 'py-2',
      default: 'py-3',
...
const ListRow = forwardRef<HTMLDivElement | HTMLButtonElement, ListRowProps>(function ListRow(
  ...
  const inferredInteractive = interactive ?? (isButton || typeof (rest as DivProps).onClick === 'function');
